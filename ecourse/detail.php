        ...
        <section class="course-description">
            ...
            <div style="margin-top:24px;">
                ...
                <div style="margin-top:8px;">
                    <?php
                        // Optional: parse bullet points if description contains lines with '-' or '*'
                        // For now, we just keep description. You can extend to a structured list later.
                    ?>
                </div>
            </div>
            ...
            <div style="margin-top:24px;">
                <h3>Prasyarat:</h3>
                <p>Disarankan memahami dasar pemrograman dan matematika (aljabar & statistik).</p>
            </div>

            <div style="margin-top:24px;">
                <a href="course-content.php?id=<?php echo $course_id; ?>" class="buy-button">Mulai Belajar</a>
            </div>
        </section>
    </main>
